  ...
  <div class="insurance">
    ...
    <div class="cardList">
      ...
      <div class="information">
        <group>
          <span>*</span>
          <popup-radio title="保额种类" :options="options10" v-model="option10" placeholder="请选择"></popup-radio>
        </group>
      </div>
    ...
    <div class="footButton1" v-if="fromCompare" @click="getAmount()">
      <div class="desc">
        <span>保费测算</span>
        <span>{{yearPermium}}</span>
      </div>
      <div class="desc"@click="goPlan()">
        <span>生成电子计划书</span>
      </div>
    </div>
  </div>
